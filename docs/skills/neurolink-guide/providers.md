...
| Google Vertex AI | `vertex` | google-vertex | gemini-3-flash |
| AWS Bedrock | `bedrock` | aws-bedrock | claude-3-sonnet |
...
const result = await neurolink.generate({
  ...
  systemPrompt: 'You are an expert TypeScript developer. Always use proper types.'
});
```
...
- [Multimodal inputs](multimodal.md) - Work with images and documents
- [MCP tools](tools-mcp.md) - Add external tools
- [RAG integration](rag-integration.md) - Document-grounded generation
