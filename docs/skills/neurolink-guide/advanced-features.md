...
emitter.on('hitl:confirmation-request', async (event) => {
  ...
  console.log(`Dangerous keywords: ${event.payload.metadata.dangerousKeywords}`);
...
- [SDK quickstart](sdk-quickstart.md) - Basic usage
