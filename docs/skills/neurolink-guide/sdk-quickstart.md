...
Priority order:
1. Vertex AI (if `VERTEX_PROJECT_ID` set)
...
- [Configure providers](providers.md) - Set up specific AI providers
- [Add multimodal inputs](multimodal.md) - Work with images and documents
- [Integrate MCP tools](tools-mcp.md) - Add external tools
- [Set up RAG](rag-integration.md) - Document-grounded generation
